  ...
  const faqItems = [
    {
      ...
      answer: 'Bạn có thể đặt hàng bằng cách chọn sản phẩm, thêm vào giỏ hàng và tiến hành thanh toán.'
    },
    {
      question: 'Thời gian giao hàng là bao lâu?',
      answer: 'Thời gian giao hàng từ 2-5 ngày làm việc tùy thuộc vào địa chỉ giao hàng.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Chúng tôi chấp nhận thanh toán bằng tiền mặt, chuyển khoản ngân hàng và ví MoMo.'
    }
  ];
            ...
            {supportMethods.map((method, index) => (
              <Box
                ...
                className={`flex items-center justify-between p-4 cursor-pointer ${
                  index === supportMethods.length - 1 ? '' : 'border-b border-gray-100'
                }`}
              >
